...
from .controllers import orders, recipes, resources, order_details, sandwiches
...
# Endpoints for Sandwiches (Assuming similar to Resources and Recipes)
...
def delete_order_detail(order_detail_id: int, db: Session = Depends(get_db)):
    order_detail = order_details.read_one(db, order_detail_id=order_detail)
